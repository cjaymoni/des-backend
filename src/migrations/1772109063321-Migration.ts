...
export class Migration1772109063321 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a5948057d5307d53fb8d75db66" ON "jobs" ("blNo") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_12e98982a50b141b1f9024236f" ON "jobs" ("ie") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2162163c2605eec6b3b2446ec0" ON "jobs" ("jobNo") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_23acb08ddd318917bfd5c32ab8" ON "bank_transactions" ("transactionDate") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_68c8871910ecc8c396cca93356" ON "bank_transactions" ("acctNumber") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4be4ea99f6404022ab9a4bb22d" ON "bank_transactions" ("bankCode") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_84c09418fd2378a61f96b3df7f" ON "bank_accounts" ("bankCode") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_5c85466672d010b6c75f4671c7" ON "bank_accounts" ("acctNumber") `,
    );
    await queryRunner.query(
      `CREATE TABLE "weight_charges" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "weightFrom" numeric(10,2) NOT NULL, "weightTo" numeric(10,2) NOT NULL, "charges" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_76529ee2fcca1d0e54ac8a8251f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "house_manifests" ADD CONSTRAINT "FK_c77e9c511ab411ca2e5eb0be633" FOREIGN KEY ("masterManifestId") REFERENCES "master_manifests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "manifest_jobs" ADD CONSTRAINT "FK_886ec26f5c6d25066acd49a45e1" FOREIGN KEY ("houseManifestId") REFERENCES "house_manifests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cif_values" ADD CONSTRAINT "FK_c2772156aa41467f6c40161f87b" FOREIGN KEY ("jobId") REFERENCES "jobs"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "cif_values" DROP CONSTRAINT "FK_c2772156aa41467f6c40161f87b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "manifest_jobs" DROP CONSTRAINT "FK_886ec26f5c6d25066acd49a45e1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "house_manifests" DROP CONSTRAINT "FK_c77e9c511ab411ca2e5eb0be633"`,
    );
    await queryRunner.query(`DROP TABLE "weight_charges"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5c85466672d010b6c75f4671c7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_84c09418fd2378a61f96b3df7f"`,
    );
    await queryRunner.query(`DROP TABLE "bank_accounts"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4be4ea99f6404022ab9a4bb22d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_68c8871910ecc8c396cca93356"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_23acb08ddd318917bfd5c32ab8"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d96331c2a35dc971177a5e2ad3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e98625f9042c2aab27c54aea31"`,
    );
    await queryRunner.query(`DROP TABLE "importer_exporters"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5bfa3c3b2f3dd98b8e0608fa8a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_53b7746a5b1e2e0a0361bda752"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ea3a141dae25e1d8054a046425"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2162163c2605eec6b3b2446ec0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_12e98982a50b141b1f9024236f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a5948057d5307d53fb8d75db66"`,
    );
    await queryRunner.query(`DROP TABLE "jobs"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_39c52b61de1fd9db138b6a3d54"`,
    );
    await queryRunner.query(`DROP TABLE "cif_values"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_827c1c3c6801f1d83b394bfff6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f5b6bab22b6dbbad38578a3651"`,
    );
    await queryRunner.query(`DROP TABLE "manifest_jobs"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_15203b8731921e8bcf27df7f52"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_00e7284bdcd78199b519542949"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c77e9c511ab411ca2e5eb0be63"`,
    );
    await queryRunner.query(`DROP TABLE "house_manifests"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a681c1e33ac0730c88627905dd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d9e3b7909ff05d50b3965c6789"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7ac7706b671697a1b3db476000"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e68d1723de3431af0785347763"`,
    );
